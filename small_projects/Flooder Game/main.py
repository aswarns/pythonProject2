import bext  # pip.exe install bext
import random
import sys
...
def ask_player_move():
    "Let the player select a color to paint upper left title"
    while True:
        bext.fg('white')
        ...
        if response == "QUIT" or response == "q" or response == "Q":
            print("Thanks for playing!")
            sys.exit()
        result = {"R": 0, "G": 1, "B": 2, "Y": 3, "P": 4, "C": 5}
